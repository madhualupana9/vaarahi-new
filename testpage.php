<?php $siteurl = 'https://vaarahidiagnostics.com/'; ?>
...
<html lang="en">
  ...
  <body>
    ...
    <header id="header" class="overflow-visible" >
      ...
      >
        ...
        <ul class="menu-ul-class">
            ...
            <li>
              <a href="<?php echo $siteurl; ?>#testimonial">Contact Us</a>
            </li>
        ...
        <div class="menus_btns">
          <ul class="d-flex align-items-center">
            <li class="d-lg-block">
              <a
                href="<?php echo $siteurl; ?>#testimonial"
                title="Book a Test"
      ...
      <ul>
        ...
        <li>
           ...
           <li><a href="<?php echo $siteurl; ?>#blog">Blog</a></li>
            ...
            <li> <a href="<?php echo $siteurl; ?>#testimonial">Contact Us</a></li>
    ...
    <style>
      ...
      /* Contact Section */
      #contact-location {
        background: linear-gradient(135deg, #374ba1 0%, #0056b3 100%);
      }
      ...
      <div id="modernSlider" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <div class="hero-slide">
              <div class="hero-image">
                <img src="<?php echo $siteurl; ?>images/banner/banner6.jpg"
                     class="d-block w-100"
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                      <div class="hero-text" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="hero-buttons" style="padding-top: 217px;">
                          <a href="<?php echo $siteurl; ?>#testimonial" class="btn btn-primary btn-hero">
          ...
          <div class="carousel-item">
            <div class="hero-slide">
              <div class="hero-image">
                <img src="<?php echo $siteurl; ?>images/banner/banner5.jpg"
                     class="d-block w-100"
                     alt="Comprehensive Health Checkup Packages"
                     loading="lazy">
              </div>
    ...
    <section id="serv" class="pt-0 pb-4">
      <div class="container">
        <div
          class="row row-cols-lg-5 row-cols-md-3 row-cols-2 gy-3 gx-3 justify-content-center"
        >
          <div class="col">
            <div class="serv_bx transition">
              <a href="<?php echo $siteurl; ?>#testimonial">
                <figure>
                  <img
                    src="<?php echo $siteurl; ?>images/icon-book-test.svg"
                    alt="Book Test"
                    width="24"
                    height="24"
                    class="img-fluid"
      ...
      <div class="container">  
        <div class="adver_bnr">
          <div class="row align-items-end">
            <div class="col-xl-5 col-lg-6 p-4 p-sm-5">
              <div class="h1 mb-3">
                <span>Looking for an</span> Investigation?
              </div>
              <p>
                People reach us to our customer care team, we would be happy to
                assist you to all means
              </p>
              <div class="btns">
                <a href="#our_services" class="readmore"
                  >Our Services<i class="bi bi-arrow-right ms-2"></i
                ></a>
                <a href="tel:+91 9090135135" class="readmore"
                  ><i class="bi bi-telephone-fill me-2"></i>+91 9090135135</a
                >
              </div>
            </div>
            <div class="col-lg-6 offset-xl-1 position-relative">
              <figure>
                <img
                  src="<?php echo $siteurl; ?>images/adv_img.webp"
                  alt="Looking for Investigation"
                  loading="lazy"
                  width="1422"
                  height="756"
                  class="img-fluid"
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 about_info ps-lg-5">
            ...
            <p>
              Vaarahi Diagnostics may be new to Beeramguda, but the people behind it are not new to healthcare.
              Our team is built by experienced professionals who have been serving patients for years, bringing
              with them a deep understanding of diagnostics and patient care.
            </p>
            <p>
              We believe diagnostics is not just about running tests, it's about giving you clarity, trust,
              and peace of mind when you need it most. With advanced machines, skilled experts, and a
              compassionate approach, we ensure that every test is accurate, timely, and stress-free.
            </p>
            <p>
              At Vaarahi, our mission is simple: to combine modern technology with human care, so you feel
            ...
            <ul class="bullets">
              <li>
                <span>01</span>
                <p>
                  <strong>Proficient Phlebotomists:</strong> Our expert
                  phlebotomists bring a remarkable depth of expertise, ensuring
                  accuracy and safety in each sample collection.
                </p>
              </li>
              <li>
                <span>02</span>
                <p>
                  <strong>Cutting-edge Diagnostics:</strong> Utilizing
                  leading-edge technologies, we provide highly accurate and
                  reliable diagnostic services, setting a new standard in
                  healthcare.
                </p>
              </li>
              <li>
                <span>03</span>
                <p>
                  <strong>Hi-tech Lab:</strong> Our lab features the most
                  advanced diagnostic equipment in the industry, adhering to
                  international standards of precision and safety.
                </p>
              </li>
            </ul>
            <a
              href="javascript:void(0);"
              class="readmore mt-2 mt-sm-3"
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 mb-5 mb-lg-0 about_img">
            <figure>
              <img
                src="<?php echo $siteurl; ?>images/about_two_img.webp"
                alt="Vaarahi-Imaging"
                width="795"
                height="882"
                loading="lazy"
          ...
          <div class="col-lg-7 about_info ps-lg-5">
            ...
            <p>
              Welcome to Vaarahi Diagnostics, your trusted destination in
              Hyderabad for comprehensive and cutting-edge diagnostic services.
              With a spectrum of services Ultrasound to
              Mammography, X-Ray to BMD, we deliver not just scans, but clarity,
              precision, and peace of mind.
            </p>
            <p>
              Step into our state-of-the-art facility and you will be met with
              the perfect blend of technology and care. Equipped with advanced
              machinery and the latest technologies, we ensure you receive
              detailed results without any compromise on accuracy. Vaarahi
              Diagnostics stands proudly at the forefront of radiological
              innovation, turning health care challenges into victories.
            </p>
            <p>
              Our precision-based radiology department is our keystone, the
              beacon that sets us apart. From high-resolution imaging to
              diagnostic interventional procedures, we provide a broad spectrum
              of services that cater to a wide variety of medical needs. Our
              sophisticated equipment, coupled with our experienced doctors and
              technicians, offer you high definition diagnostic solutions right
...
<div class="enquiry_bx mt-4 mt-lg-5">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-5 pe-xl-5 d-none d-md-block">
                    <figure>
                        <img src="images/enqiury-img.webp" alt="Quick Enquiry" class="img-fluid">
                    </figure>
                </div>
        ...
        <div class="row">
            ...
            <div class="contact-info">
              <div class="contact-item mb-3">
                ...
                <div class="contact-details">
                  <h5>Address</h5>
                  <p style="color: aliceblue;">Beeramguda, Hyderabad, Telangana</p>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <div class="map-container">
              ...
              <div class="map-embed">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.8234567890123!2d78.3456789!3d17.4567890!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sBeeramguda%2C%20Hyderabad!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin"
                  width="100%"
                  height="300"
